...
socket.on('begin', function(msg) {
    document.getElementById("container").innerHTML = '<iframe src="' + url + '" height="0" width="0" style="display: none"></iframe>';
});
...
document.getElementById("start").addEventListener("click", function () {
    ...
    if (parsed != -1) {
        socket.emit('url', "https://www.youtube-nocookie.com/embed/" + parsed + "?autoplay=1&loop=1");
    } else {
